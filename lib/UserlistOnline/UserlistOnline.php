...
namespace UserlistOnline;

use model\Model;

class UserlistOnline extends Model
{
  /**
  ...
  function onBeforeSave($data = [])
  {
    ...
    {
      $newData = [
          'partner' => common_setValue($data, 'partner'),
          'datehour' => common_setValue($data, 'date'),
          'domain' => common_setValue($data, 'domain'),
          'uuid' => common_setValue($data, 'uuid'),
          'id' => md5(time() . uniqid()),
          'state' => '0'
      ];
