            ...
            if (empty($data['diff']))
            {
                    ...
                    for ($i = 0; $i < $ic = count($data); $i++)
                    {
                        ...
                        <tr>
                            <td>
                                ...
                                <?php
                                if(!empty($data['allDomain']) && !empty($data[$i]['domain'])
                                    && array_key_exists($data[$i]['domain'], $data['allDomain'])
                                )
                                {
                                    echo $data['allDomain'][$data[$i]['domain']];
																		$to_excel = 1;
                                }else{
                                    continue;
                                }
                ...
                else
                {
                    ...
                    for ($i = 0; $i < $ic = count($data); $i++)
                    {
                        ...
                        {
                            $key = $params['group'][$data[$i]['domain']];
                            ...
                            $arResult[$key]['html'] .= '<tr><td>' . $data['allDomain'][$data[$i]['domain']] . '</td><td>' . (!empty($data[$i]['c']) ? $data[$i]['c'] : 0) . '</td><td>'. $data[$i]['c_bots'] .'</td><td>'. common_percent_from_number($data[$i]['c'], $data[$i]['c_bots']) .'</td><td>'. $data[$i]['c_ads'] .'</td><td>'. common_percent_from_number($data[$i]['c'], $data[$i]['c_ads']) .'</td></tr>';
                        }
                    }
                    ...
                    <!--panel-group-->
                    <div class="panel-groupc" id="accordion" >
